...
// We can also return another promise. The next .then() case if the success case for the returned promise. The return key is very important for the next success case. In the above we could have returned nothing or returned any other data types supported by promises. The below is an example of returning a promise. The .then() method will only run when the second/new promise resolves.

// promise.then((data) => {
//    console.log('1', data);
//    return new Promise((resolve, reject) => {
//       setTimeout(() => {
//          resolve('This is a new resolved promise');
//       }, 5000)
//    });
// }).then((str) => {
//    console.log('promise chaining', str);
